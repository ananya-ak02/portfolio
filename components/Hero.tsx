...
export default function Hero() {
  ...
  return (
    <section id="hero" className="w-full flex flex-col justify-center min-h-[85vh] px-8 md:px-16 pt-20 pb-10">
      <div className="max-w-3xl">
        <span className="font-mono text-text-secondary text-sm md:text-base tracking-widest uppercase mb-4 block">
          Software Engineer
        </span>
        ...
        <p className="text-text-secondary text-base md:text-lg leading-relaxed mt-6 mb-8 max-w-2xl">
          I'm a CS student at Thapar building production-grade AI systems — RAG pipelines, LangChain agents, and multimodal vision models. Focused on clean architecture and high-performance engineering.
        </p>
